...
namespace NinjaGame
{
    //#############################################################################################
    /// <summary>
    /// This widget displays the player's score as a number.
    /// </summary>
    //#############################################################################################

    public class Gui_Score : GuiWidget
    {
        //=========================================================================================
        // Properties
        //=========================================================================================
        ...
        public override void OnDraw()
        {
            ...
            float score = 0;

                {
                    ...
                    // See if found: if so then get score

                    if ( rules != null ) score = rules.PlayerScore;
                }

            // Round score:

            score = (float) Math.Ceiling( score );
            ...
            if ( m_center )
            {
                ...
                m_font.DrawStringCentered( ((int)(score)).ToString() , Position , view_projection );
            }
            else
            {
                // Draw non centered:
            
                m_font.DrawString( ((int)(score)).ToString() , Position , view_projection );
            }
        }
