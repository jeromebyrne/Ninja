...
namespace NinjaGame
{
    //#############################################################################################
    /// <summary>
    /// Class that represents a simple picture or image on the GUI. Allows an image to be shown.
    /// </summary>
    //#############################################################################################

    public class Gui_Picture : GuiWidget
    {
        //=========================================================================================
        // Properties
        //=========================================================================================
        ...
        public override void OnDraw()
        {
            ...
            // Set the posiiton of all the sprites vertices:
            ...
            if ( m_flip_horizontal == false )
            {
                ...
                m_vertices[2].TextureCoordinate.X = m_horizontal_repeats;
                m_vertices[3].TextureCoordinate.X = m_horizontal_repeats;
            }
            else
            {
                m_vertices[0].TextureCoordinate.X = m_horizontal_repeats;
                m_vertices[1].TextureCoordinate.X = m_horizontal_repeats;
