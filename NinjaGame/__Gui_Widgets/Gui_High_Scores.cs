...
namespace NinjaGame
{
    //#############################################################################################
    /// <summary>
    /// Like the Level_End_Gui_Scores widget, but displays high scores for a particular set level 
    /// and does not save the current player score in the level.
    /// </summary>
    //#############################################################################################

    public class Gui_High_Scores : GuiWidget
    {
        //=========================================================================================
        // Properties
        //=========================================================================================
        ...
        //=========================================================================================
            ...
            /// <summary> Name of the level we are displaying the scores for. </summary>
        ...
        public override void ReadXml( XmlObjectData data )
        {
            ...
            data.ReadString ( "LevelName"                   , ref m_level_name                      , ""            );
        ...
        public override void WriteXml( XmlObjectData data )
        {
            ...
            data.Write( "LevelName"                     , m_level_name                      );
        ...
        public override void OnDraw()
        {
            ...
            LevelHighScores.HighScoreRecord high_score = LevelHighScores.GetLevelRecords(m_level_name);
